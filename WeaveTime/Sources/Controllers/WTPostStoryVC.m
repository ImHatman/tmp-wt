...
#import "WTPostStoryVC.h"

@interface WTPostStoryVC ()

@property (nonatomic) BOOL isFirstLayout;

@end

@implementation WTPostStoryVC
...
+ (WTPostStoryVC *)controller {
    return [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"WTPostStoryVC"];
}
