...
#import "WTStoryDetailsVC.h"

@interface WTStoryDetailsVC ()

@property (nonatomic) BOOL isFirstLayout;

@end

@implementation WTStoryDetailsVC
...
+ (WTStoryDetailsVC *)controller {
    return [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"WTStoryDetailsVC"];
}
