...
@interface WTEventsVC ()

@property (nonatomic) BOOL isFirstLayout;

@end

@implementation WTEventsVC
...
+ (WTEventsVC *)controller {
    return [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"WTEventsVC"];
}
