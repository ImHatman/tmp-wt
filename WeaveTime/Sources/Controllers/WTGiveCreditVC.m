...
#import "WTGiveCreditVC.h"

@interface WTGiveCreditVC ()

@property (nonatomic) BOOL isFirstLayout;

@end

@implementation WTGiveCreditVC
...
+ (WTGiveCreditVC *)controller {
    return [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"WTGiveCreditVC"];
}
